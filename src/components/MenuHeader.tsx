...
const MenuHeader = ({ menuData: { liveUrl, lastDateSession } }: MenuHeaderProps) => {
    ...
    const classNameLinksMenu = "flex flex-col justify-center items-center font-medium px-2 py-2 md:px-5 md:py-2  text-center w-1/4 max-w-xs hover:bg-gradient-to-r from-blue-500  to-blue-400";
    ...
    return (
        <>
            ...
            <div className="flex justify-center items-center shadow-lg w-full z-10  text-white bg-gray-800 fixed bottom-0">
                ...
                <a href="#session-past" className={classNameLinksMenu} title={`Última Sesión ` + lastDateSession}>
                    ...
                    <span className="text-xs md:text-sm">Pasadas</span>
                ...
                <a target='_blank' href={liveUrl} className={classNameLinksMenu} rel="noopener noreferrer">
                    ...
                    </svg> <span className="text-xs md:text-sm"> Ver Directo</span>
                </a>
