    ...
    return (
        <>
            <div className="flex justify-center items-center shadow-lg w-full bg-white sticky top-0 max-w-6xl mx-auto">
                ...
                <a href={"#" + lastDateSession} className="flex justify-center font-medium px-2 py-2 md:px-5 md:py-2 bg-white text-gray-800 border-gray-200 hover:bg-rose-700 hover:text-white text-ellipsis overflow-hidden text-center w-1/3">
                    Última Sesión {lastDateSession}
                </a>
