import './App.css'
import jsonData from './data/COAC_2024_ADULTOS_SEMI.json';
    ...
    <>
      ...
      <header id="siteHeader" className="text-center bg-gray-800">
        <hgroup className='flex justify-center items-center max-w-6xl mx-auto p-6  '>
          <h1 className="text-2xl font-extrabold leading-tighter tracking-tighter mb-4 text-white" >¿Quién canta hoy en el COAC 2024? <br />   <strong className="text-5xl bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400 uppercase">adultos semifinales</strong></h1>
        </hgroup>
      </header>
